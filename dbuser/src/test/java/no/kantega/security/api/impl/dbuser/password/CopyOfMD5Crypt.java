...
public class CopyOfMD5Crypt implements PasswordCrypt {
     ...
     */
    static public final String crypt( String password, String salt, String magic ) throws NoSuchAlgorithmException {
    ...
    public static void main(String[] args) {
        try {
            String cryptPW = new CopyOfMD5Crypt().crypt("password");
